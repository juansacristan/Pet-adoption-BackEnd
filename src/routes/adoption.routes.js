...
router.post('/', validateAuthUser, createAdoption); //Registrar adoptado
router.get('/:id', validateId, getAdoption); // Obtener el adoptado de Id
router.delete ('/:id', validateId, validateAuthUser, deleteAdoption); // Eliminar un adopato
router.patch ('/:id', validateId, validateAuthUser, patchAdoption); //Actualizar el adoptado
